...
class PostgresParseSTData:
    ...
    def makeInsertSTDataSchema(
        self, postgresCtrl, tableName, schemaDict, schemaFilePath, columnList=None
    ):
        postgresCtrl.connect()
...
if __name__ == "__main__":
    ...
    from src.database.PostgresCtrl import PostgresCtrl
